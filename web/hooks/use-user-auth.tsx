...
const useUserAuth = (routeAuth: "sign-in" | "onboarding" | "admin" | null = "admin") => {
  ...
  useEffect(() => {
    const handleWorkSpaceRedirection = async () => {
      console.log('workspace redirection starting')
      workspaceService.userWorkspaces().then(async (userWorkspaces) => {
        ...
        console.log('last workspace invitation', lastActiveWorkspace)
        ...
        console.log('creating workspace starts', lastActiveWorkspace)
